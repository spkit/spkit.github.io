...
<div id="index-grid-half" class="section group">
 ...
 <hr width="10%">
  ...
  <div class="sphx-glr-thumbcontainer" tooltip="Topographical Maps.">
     ...
     <p class="caption"><span class="caption-text"><a class="reference internal" href="examples/gen_topo"  target="_blank"><span class="std std-ref">Topographic Map</span></a></span><a class="headerlink" href="#" title="Permalink to this image">¶</a></p>
     </div>
   </div>
   <div class="toctree-wrapper compound"></div>
   <hr width="10%">
